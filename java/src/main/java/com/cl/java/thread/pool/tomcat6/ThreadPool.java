...
package com.cl.java.thread.pool.tomcat6;
...
public class ThreadPool  {
    ...
    public synchronized void start() {
        ...
        //初始化线程数组（按minSpareThreads）
        openThreads(minSpareThreads);
        //如果最大空闲线程数小于最大线程数，就启动监控器控制最大空闲线程
    ...
    public void run(Runnable r) {
    	//找到可用的线程，如果当前线程池不够用，就增加当前线程池的线程数量，如果满了，就等待
        ControlRunnable c = findControlRunnable();
        //执行，平时线程是等待的，执行此方法后，唤醒之
        c.runIt(r);
    }    
